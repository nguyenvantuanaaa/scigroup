...
document.getElementsByClassName('person_sci_1_0_0__right')[0].innerHTML = tempPerson(dataPerson[0])
...
for (let i = 0; i < tabPerson.length; i++) {
    tabPerson[i].addEventListener('click', () => {
        ...
        document.getElementsByClassName('person_sci_1_0_0__right')[0].innerHTML = tempPerson(dataPerson[i])
